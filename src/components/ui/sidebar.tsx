...
export function SidebarMenuComponent({ className, children, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
...
export function SidebarMenuItemComponent({ className, children, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
...
export function SidebarTrigger({ className, ...props }: React.ButtonHTMLAttributes<HTMLButtonElement>) {
  ...
  return (
    <button
      className={cn("h-9 w-9 rounded-md border p-2 text-muted-foreground", className)}
